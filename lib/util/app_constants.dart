...
import 'package:Abiadh_mart/data/model/response/choose_us_model.dart';
import 'package:Abiadh_mart/data/model/response/language_model.dart';
import 'package:Abiadh_mart/util/images.dart';

class AppConstants {
  static const String appName = 'Abiadh';
  static const double appVersion = 2.5;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://Abiadh.online';

  static const String baseUrl = 'https://Abiadh.online';
